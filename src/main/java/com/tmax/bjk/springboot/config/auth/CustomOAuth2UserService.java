...
import com.tmax.bjk.springboot.config.auth.dto.OAuthAttributes;
import com.tmax.bjk.springboot.config.auth.dto.SessionUser;
import com.tmax.bjk.springboot.domain.user.User;
import com.tmax.bjk.springboot.domain.user.UserRepository;
